<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" 
    CodeBehind="AddAnnouncement.aspx.cs" Inherits="SchoolManagementSystem.Admin.AddAnnouncement" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:CheckBoxList ID="chkAudience" runat="server">
            ...
            <asp:ListItem Text="All Admins" Value="AllAdmins"></asp:ListItem>
        </asp:CheckBoxList>
