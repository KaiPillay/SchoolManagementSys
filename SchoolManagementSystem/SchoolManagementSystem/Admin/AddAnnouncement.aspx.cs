...
namespace SchoolManagementSystem.Admin
{
    public partial class AddAnnouncement : System.Web.UI.Page
    {
        ...
        {
            // Temporarily bypass session checks
            //if (Session["UserID"] == null || (Session["UserRole"].ToString() != "Admin" && Session["UserRole"].ToString() != "Teacher"))
            //{
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connString))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@AuthorID", 1); // Temporarily hardcode AuthorID
